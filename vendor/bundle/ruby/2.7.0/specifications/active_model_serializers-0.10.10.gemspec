# -*- encoding: utf-8 -*-
# stub: active_model_serializers 0.10.10 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    s.add_runtime_dependency(%q<activemodel>.freeze, [">= 4.1", "< 6.1"])
    s.add_runtime_dependency(%q<actionpack>.freeze, [">= 4.1", "< 6.1"])
    s.add_development_dependency(%q<railties>.freeze, [">= 4.1", "< 6.1"])
    ...
    s.add_development_dependency(%q<activerecord>.freeze, [">= 4.1", "< 6.1"])
    ...
    s.add_dependency(%q<activemodel>.freeze, [">= 4.1", "< 6.1"])
    s.add_dependency(%q<actionpack>.freeze, [">= 4.1", "< 6.1"])
    s.add_dependency(%q<railties>.freeze, [">= 4.1", "< 6.1"])
    ...
    s.add_dependency(%q<activerecord>.freeze, [">= 4.1", "< 6.1"])
